...
\begin{itemize}[leftmargin=2em]
    ...
    \item \textbf{Unbreakable rock platforms.} Scattered stone ledges and rocky outcrops serve as safe resting points where players can catch their breath, check inventory, and plan the next stretch of the ascent. Rocks cannot be sticked into by icepicks. This will be implemented with Unity rigid body to determine whether the icepick will hold or drag down.

    \item \textbf{Resource management.} There will be no stamina or hunger or similar gauges. Players need to manage supporting gadgets like grappling gun hook, cold spray that makes the ice more rigid so that it takes more time to crack, helmet that protects one falling rock strike, and poles that can be attached to rocks to allow the icepick hold onto it.
