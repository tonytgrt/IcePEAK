...
\textbf{Winning condition.} The player wins by reaching the summit platform at the top of the mountain. The player loses by falling below the last safe rock platform with no way to recover.
...
% Include sketches of the worlds along with brief descriptions.

\subsubsection{Characters}
% Include sketches of all the characters along with brief descriptions
